const apikey = 'b6be60f57a24432f8589b6c616e90947';
...
async function fetchRandomNews(){
    try{
        const apiUrl =`https://newsapi.org/v2/everything?q=tesla&from=2024-09-16&sortBy=publishedA&pageSize=15&apikey=${apikey}`;
